...
class VersionSerializerTest(TestCase):
    def test_ok(self):
        ...
        serializer_data = VersionSerializer(
            all_versions,
            many=True
        ).data
        ...
        expected_data = [
            {
                ...
                'id': page.id,
                'created': page.created.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                'history_date': all_versions[0].history_date.strftime(
                    "%Y-%m-%dT%H:%M:%S.%fZ"
                ),
                'title': 'Test title(original)',
                'text': 'Test content(original)',
            ...
            },
            {
                ...
                'created': page.created.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                'history_date': all_versions[1].history_date.strftime(
                    "%Y-%m-%dT%H:%M:%S.%fZ"
                ),
                'title': 'Test title(edit1)',
                'text': 'Test content(edit1)',
            ...
            },
            {
                ...
                'created': page.created.strftime("%Y-%m-%dT%H:%M:%S.%fZ"),
                'history_date': all_versions[2].history_date.strftime(
                    "%Y-%m-%dT%H:%M:%S.%fZ"
                ),
                'title': 'Test title(edit2)',
                'text': 'Test content(edit2)',
